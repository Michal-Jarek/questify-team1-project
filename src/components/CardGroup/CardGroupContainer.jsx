		...
		if (isLoading) {
			...
			return (
				<>
					{!challengeState ? (
						<>
							<CardGroup cards={cards} groupName='create new card' hideLabel={false} />
							<CardGroup cards={cards} groupName='past' hideLabel={false} />
							<CardGroup cards={cards} groupName='today' hideLabel={false} />
							<CardGroup cards={cards} groupName='tomorrow' hideLabel={false} />
							<CardGroup cards={cards} groupName='upcoming' hideLabel={false} />
						</>
					) : (
